"""hsequploader URL Configuration
...
from hsequploader.views import HomePageView
...
urlpatterns = [
    ...
    path('api/', include('hsequploader.api_urls')),
    path('manage/', include('hsequploader.manage_urls')),
