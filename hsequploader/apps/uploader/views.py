...
from hsequploader.mixins import FormRequestMixin
from hsequploader.virtuoso import insert
...
class UploadCreate2View(FormRequestMixin, CreateView):

    model = Upload
    form_class = UploadForm
    template_name = 'uploader/form2.html'

    def get_context_data(self, *args, **kwargs):
        context = super(UploadCreate2View, self).get_context_data(*args, **kwargs)
        return context
