...
class UploadForm(forms.ModelForm):
    ...
    sequence_read_1_location = forms.CharField()
    ...
    def file_fields(self):
        ...
        return [self['sequence_read_1'], self['metadata_file']]
    ...
    #     print("Hey.......", self.cleaned_data['sequence_read_1'])
    ...
    def clean_sequence_read_1_location(self):
        sequence_read_1_location = self.cleaned_data['sequence_read_1_location']
        try:
            qc_fasta_lite(os.path.join(settings.TUS_DESTINATION_DIR, sequence_read_1_location))
        except ValueError:
            raise ValidationError("Invalid file format")
        except OSError as e:
            raise ValidationError(e)
        return sequence_read_1_location
    ...
    def save(self):
        ...
        if not self.instance.id:
            self.instance.save()
        sequence_read_1 = os.path.join(settings.TUS_DESTINATION_DIR, self.cleaned_data['sequence_read_1_location'])
