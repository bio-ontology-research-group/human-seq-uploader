...
class TusUpload(View):
    ...
    def patch(self, request, resource_id, *args, **kwargs):
        ...
        if tus_file.is_complete():
            ...
            self.finished()
            return TusResponse(status=204, extra_headers={'Upload-Offset': tus_file.offset, 'Location': '{}'.format(tus_file.filename)})
    ...
    def move_simple(self, tusfile):
        print(os.path.join(settings.TUS_DESTINATION_DIR, tusfile.resource_id))
