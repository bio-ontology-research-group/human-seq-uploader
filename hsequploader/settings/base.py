"""
Django settings for hsequploader project.
...
configFile = config_dir + "/hsequploader.ini"

if not os.path.isfile(configFile):
    os.makedirs(config_dir, exist_ok=True)
    shutil.copyfile("default_hsequploader.ini", configFile)
...
ROOT_URLCONF = 'hsequploader.urls'
...
WSGI_APPLICATION = 'hsequploader.wsgi.application'
...
# TUS_EXISTING_FILE = 'overwrite'  # 'overwrite'  'error', 'rename'